...
/*# sourceURL=https://usaxy.org/wp-includes/blocks/heading/style.min.css */
</style>
...
/*# sourceURL=https://usaxy.org/wp-includes/blocks/image/style.min.css */
</style>
<style id="wp-block-list-inline-css">
ol,ul{box-sizing:border-box}:root :where(.wp-block-list.has-background){padding:1.25em 2.375em}
/*# sourceURL=https://usaxy.org/wp-includes/blocks/list/style.min.css */
</style>
...
/*# sourceURL=https://usaxy.org/wp-includes/blocks/paragraph/style.min.css */
</style>
<style id="wp-block-spacer-inline-css">
.wp-block-spacer{clear:both}
/*# sourceURL=https://usaxy.org/wp-includes/blocks/spacer/style.min.css */
</style>
...
<div class="desktop-simple-header">
    <!-- Overhead Section -->
    <div class="overhead">
        <div class="container">
...
<li id="menu-item-24" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-24"><a href="/contacts/">聯繫我們</a></li>
    ...
    /* Overlay */
    .mobile-header-container .mobile-menu-overlay {
        position: fixed;
        top: 0;
        left: 0;
        width: 100%;
    ...
    .mobile-header-container .mobile-menu-overlay.open {
        opacity: 1;
        visibility: visible;
    }
    ...
    /* Styling for Submenu */
    .mobile-header-container .mobile-menu .submenu {
        list-style: none;
        padding-left: 20px;
        margin-top: 0;
        margin-bottom: 0;
    ...
    .mobile-header-container .mobile-header .hamburger-menu.open {
        display: none;
    }

    .mobile-header-container .mobile-header .close-menu.open {
        display: block;
    }
...
<div class="mobile-header-container">
    <div class="mobile-header">
        ...
        <div class="hamburger-menu" id="mobileHeaderHamburger">☰</div>
        <div class="close-menu" id="mobileHeaderCloseButton">&times;</div>
    </div>

    <div class="mobile-menu-overlay" id="mobileHeaderOverlay"></div>

    <div class="mobile-menu" id="mobileHeaderMenu">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const hamburger = document.getElementById("mobileHeaderHamburger");
        const mobileMenu = document.getElementById("mobileHeaderMenu");
        const closeButton = document.getElementById("mobileHeaderCloseButton");
        const menuOverlay = document.getElementById("mobileHeaderOverlay");
